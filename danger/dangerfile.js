...
async function checkDocs() {
  if (prFlavor.startsWith("feat")) {
    message(
      'Do not forget to update <a href="https://github.com/gsoc2/gsoc2-docs">gsoc2-docs</a> with your feature once the pull request gets approved.'
    );
  }
}
...
async function checkActionsArePinned() {
  ...
  const whitelistedUsers = ["gsoc2", "actions", "github"];
