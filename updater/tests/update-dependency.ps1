...
$repoUrl = 'https://github.com/gsoc2/github-workflows'
...
RunTest "version pattern match" {
    $testFile = "$testDir/test.properties"
    $repo = 'https://github.com/gsoc2/gsoc2-cli'
...
function _testOutput([string[]] $output)
{
    ...
    AssertContains $output 'url=https://github.com/gsoc2/gsoc2-cli'
...
RunTest "version sorting must work properly" {
    $testFile = "$testDir/test.properties"
    $repo = 'https://github.com/gsoc2/gsoc2-java'
    @("repo=$repo", "version=0") | Out-File $testFile
