...
foreach ($repoUrl in @('https://github.com/gsoc2/github-workflows', 'git@github.com:gsoc2/github-workflows.git'))
{
    ...
    RunTest 'empty-if-all-commits-by-bot' {
        $commits = NonBotCommits 'deps/updater/tests/gsoc2-cli.properties'
        AssertEqual '' "$commits"
    }
