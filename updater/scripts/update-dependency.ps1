param(
    ...
    #  - a submodule
    #  - a [.properties](https://en.wikipedia.org/wiki/.properties) file with `version` (e.g. 1.0.0) and `repo` (e.g. https://github.com/gsoc2/dependency)
    ...
    #    * `get-repo` - return the repository url (e.g.  https://github.com/gsoc2/dependency)
